...
import polylink.sdk.pl.c.nativ.PolyLinkAPI20;

public class SdkStrategyUnder21 implements ISdkStrategy {
	private final String BINARY_DEST_DIR_NAME 	= "bin";
	private final String BINARY_FILE_NAME		= "PolyLink_sdk";
	...
	@Override
	public void onPersistentCreate(final Context context, final SdkConfigurations configs) {
